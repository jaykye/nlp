...
# where pos is position and i is the dimension. Embedding matrix에 진짜 말 그대로 더할꺼야.

# Embedding matrix shape: (vocab size, embed_dim)
...
def positional_encoding(position, d_model):
    # TODO: is position the position in the sentence??
    # 맞는 것 같네 max라고 해서 큰 숫자 집어넣어도 결국 처음부터 seq_len까지만 slice해서 사용함.
    ...
    return tf.cast(pos_encoding, dtype=tf.float32)  # this is 3D, with length of 1 that has 2D matrix
